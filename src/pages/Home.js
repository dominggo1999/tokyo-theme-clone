...
const Home = () => {
  ...
  return (
    <div
      className="section h-screen min-h-[400px] w-full flex justify-center items-center bg-lightBeige xl:ml-[440px] xl:py-10 xl:pr-10 overflow-hidden"
    >
      <div
        ref={section}
      ...
      >
        <div
          className="w-[300px] min-w-[300px] h-[300px] min-h-[300px] overflow-hidden animate-morph rounded-morph relative z-10"
        >
          <div
